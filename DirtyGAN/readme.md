...
使用从学习到的VAE中采样的好处是，我们甚至可以使用它来创建动画遮罩，例如，模拟动态污渍效果，如大雨中的水滴，或者能够研究动态污渍的影响。在训练了VAE之后，我们限制CycleGAN只能应用在与生成的 _“干净”到“污渍”翻译的遮罩_ 或 ~由污渍语义分割遮罩M获得的遮罩相对应的遮罩区域~。下图描绘了整个DirtyGAN方案    
![6](img/dc-ds.png)     
![6](img/ds-dc.png)   
