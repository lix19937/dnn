...
def make_parser():
    ...
    parser.add_argument("--trt", dest="trt", default=True, action="store_true", help="Using TensorRT model for testing.")
    ...
    parser.add_argument("--plan_file", type=str, default='./datasets/', help="data dir")
