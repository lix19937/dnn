...
def multiclass_nms_rotated(multi_bboxes,
    ...
    _, keep = nms_rotated(bboxes_for_nms, scores, nms)
...
def aug_multiclass_nms_rotated(merged_bboxes, merged_labels, score_thr, nms,
    ...
    for cls in range(classes):
        ...
        cls_dets, _ = nms_rotated(cur_bboxes[:, :5], cur_bboxes[:, -1], nms.iou_thr)
        cls_labels = merged_bboxes.new_full((cls_dets.shape[0],), cls, dtype=torch.long)
