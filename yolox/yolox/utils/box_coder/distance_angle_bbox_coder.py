# -*- coding: utf-8 -*-
# @Time    : 2022/8/8 下午5:03
# @Author  : Teanna
# @File    : distance_angle_bbox_coder.py.py
# @Software: PyCharm
...
class DistanceAnglePointCoder(BaseBBoxCoder):
    ...
    def decode(self, points, pred_bboxes, max_shape=None):
        ...
        if self.clip_border is False:
            max_shape = None
        return self.distance2obb(points, pred_bboxes, max_shape, self.angle_version)
    ...
    def obb2distance(self, points, distance, max_dis=None, eps=None):
        ...
        rot_matrix = torch.cat([cos_angle, sin_angle, -sin_angle, cos_angle], dim=1).reshape(-1, 2, 2)
