...
def eval_arb_map(det_results, annotations, scale_ranges=None, iou_thr=0.5, use_07_metric=True, nproc=4):
    ...
    for i in range(num_classes):
        ...
        tpfp = pool.starmap(tpfp_default, zip(cls_dets, cls_gts, cls_gts_ignore,
...
def tpfp_default(det_bboxes, gt_bboxes, gt_bboxes_ignore=None, iou_thr=0.5, area_ranges=None):
    ...
    # logger.info('ious_max: {}'.format(ious_max))
